    ...
    public partial class ManageUsers : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["role"].ToString() != "admin")
            {
                ...
                foreach (userRow dbRow in Database.userList)
                {
        ...
        {
            Session["editUser"] = e.CommandArgument.ToString();
        ...
        public void deleteBtnClick(object sender, CommandEventArgs e)
        {
            ...
            try { Database.deleteUser(e.CommandArgument.ToString()); }
            catch(Exception exc)
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Error: Failed to communicate with database')", true);
                return;
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "alert('" + e.CommandArgument.ToString() + " was deleted'); window.location='" +
